...
private:
    ...
    QImage img, tekstura,tekstura2, wynik;
    unsigned char *bits;
    ...
    void teksturujKwadrat(int px0, int py0, int px1, int py1, int px2, int py2, int px3, int py3, double kat);
    void teksturujTrojkat(int px0, int py0, int px1, int py1, int px2, int py2, double kat);
